...
export default function Template({
  ...
  return (
    <Layout location={location}>
      <Article>
        {renderAst(htmlAst)}
        {pageContext.showTableOfContents && (
          <ToC headings={markdownRemark.headings} />
        )}
        <Links prev={pageContext.prev} next={pageContext.next}>
          {pageContext.prev && (
            <NavItem to={pageContext.prev.frontmatter.slug} prev>
          ...
          {pageContext.next && (
            <NavItem to={pageContext.next.frontmatter.slug} next>
